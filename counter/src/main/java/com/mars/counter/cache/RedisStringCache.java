...
public class RedisStringCache {
    ...
    public void setRedisStringCache(RedisStringCache redisStringCache) {
    ...
    public static void cache(String key,String value, CacheType cacheType){
        ...
        redisStringCache.getTemplate().opsForValue().set(cacheType.type()+key,value,
                expireTime, TimeUnit.SECONDS);
    }

    //查询缓存
    public static String get(String key, CacheType cacheType){
        return redisStringCache.getTemplate().opsForValue()
